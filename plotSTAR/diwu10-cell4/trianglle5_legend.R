...
Mlabel[which(Mlabel == '')] <- 'ns'
P.bar(c(1), c(2, 3, 4), MMax, length = 0.05, lwd = 2.1)
text(c(1.5, 2, 2.5), MMax*1.04, labels = Mlabel, cex = 2.6)

text(2.5, (lim/1.5)*1.38, labels = paste0("Concentration = ", myF_concertion, " uM/L"), font = 2, cex = 1.3, col = boxcolor)
