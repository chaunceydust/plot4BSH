...
myCol <- c('#1E90FF', '#228B22', '#6B8E23', 'white') ##  DodgerBlue #1E90FF，ForestGreen #228B22，OliveDrab #6B8E23
boxcolor <- 'red' # '#f2be45'  # ,'#ff3300'
CellType <- c("NCM460", "HT29", "RKO")

pdf('triangle3.pdf', height = 5, width = 10)
...
Data80 <- Data[which(Data$Concentration == 80),]
...
text(2, 186, labels = "Concentration = 80 uM/L", font = 2, cex = 1.3, col = boxcolor)
